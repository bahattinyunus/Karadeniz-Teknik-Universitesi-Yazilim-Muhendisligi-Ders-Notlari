...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/GÜVENLİK-KİLİTLENDİ-ff0055?style=for-the-badge&logo=adafruit" alt="Güvenlik">
  <img src="https://img.shields.io/badge/ERİŞİM-EVRENSEL-7cff00?style=for-the-badge&logo=google-earth" alt="Erişim">
</p>
...
graph LR
    subgraph "GİRİŞ"
    A[Mühendislik Temelleri] --> B[Programlama & Mantık]
    end
    subgraph "GELİŞİM"
    B --> C[Nesne Yönelimli Dünya]
    C --> D[Sistem & Veritabanı]
    end
    subgraph "USTALIK"
    D --> E[Mimari & Tasarım]
    E --> F[Yapay Zeka & Uzmanlık]
    end
    subgraph "ÇIKIŞ"
    F --> G[Sektörel Dominasyon]
    end
